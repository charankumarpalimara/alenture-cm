...
const NewExperiences = ({ apiUrl }) => {
  ...
  const fetchTickets = async () => {
    try {
      ...
      if (role === "crm") {
        url = `${process.env.REACT_APP_API_URL}/v1/getNewTicketsbyCrmid/${getCreaterId()}`;
      } else if (role === "cm") {
        url = `${process.env.REACT_APP_API_URL}/v1/getNewTicketsbyCmid/${getCreaterId()}`;
      }
      else if (role === "hob") {
        url = `${process.env.REACT_APP_API_URL}/v1/getAllNewExperiences`;
      } else if (role === "admin") {
        url = `${process.env.REACT_APP_API_URL}/v1/getAllNewExperiences`;
      } else {
