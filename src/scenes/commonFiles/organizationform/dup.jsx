...
const OrganizationForm = () => {
  ...
  const [detailsFrom, setDetailsForm] = useState(false)
...
{/* 
      ...
      <Box m="15px" sx={{ backgroundColor: "#ffffff", padding: "20px", display: detailsFrom ? "none" : "block" }} >
